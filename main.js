$(document).ready(function(){
  	...
  	$('#carousel11').carousel('pause');

  	$("#flip12").click(function(){
    	$("#panel12").slideToggle("slow");
  });

  	$('#carousel12').carousel('pause');

  	$("#flip13").click(function(){
    	$("#panel13").slideToggle("slow");
  });

  	$("#flip131").click(function(){
    	$("#panel131").slideToggle("slow");
  });

  	$('#carousel131').carousel('pause');

  	$("#flip132").click(function(){
    	$("#panel132").slideToggle("slow");
  });

  	$('#carousel132').carousel('pause');

  	$("#flip14").click(function(){
    	$("#panel14").slideToggle("slow");
  });

  	$('#carousel14').carousel('pause');
  	...
  	$("#flip211").click(function(){
    	$("#panel211").slideToggle("slow");
  });

  	$('#carousel211').carousel('pause');

  	$("#flip212").click(function(){
    	$("#panel212").slideToggle("slow");
  });

  	$('#carousel212').carousel('pause');

  	$("#flip213").click(function(){
    	$("#panel213").slideToggle("slow");
  });

  	$('#carousel213').carousel('pause');

  	$("#flip22").click(function(){
    	$("#panel22").slideToggle("slow");
  });

  	$('#carousel22').carousel('pause');

  	$("#flip23").click(function(){
    	$("#panel23").slideToggle("slow");
  });

  	$('#carousel23').carousel('pause');
  	...
  	$('#carousel39').carousel('pause');

  	$("#flip310").click(function(){
    	$("#panel310").slideToggle("slow");
  });

  	$('#carousel310').carousel('pause');

  	  	$("#flip311").click(function(){
    	$("#panel311").slideToggle("slow");
  });

  	$('#carousel311').carousel('pause');
});